<div align="center">
  <img src="https://avatars.githubusercontent.com/u/124847965?v=4" alt="Foto de perfil" width="150" style="border-radius: 50%; float: right; margin-left: 20px;"/>
  
  <h1>Mariano Maldonado</h1>
  <h3>Analista de Sistemas | Programador Back-End Jr.</h3>
  
  <div style="text-align: left; margin-top: 30px;">
    <h2>👨‍💻 Acerca de mí</h2>
    <p>
      Técnico Analista de Sistemas y Programador Back-End Jr. con formación en Java y Spring Framework. 
      Graduado del programa Oracle Next Education (ONE) y actualmente ampliando conocimientos en Desarrollo 
